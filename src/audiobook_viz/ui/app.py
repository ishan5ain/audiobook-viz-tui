...
class AudiobookVizApp(App[None]):
    ...
    def __init__(
        ...
        *,
        ...
        initial_subtitle_display_mode: SubtitleDisplayMode = SubtitleDisplayMode.WINDOW,
    ...
    def action_toggle_subtitle_mode(self) -> None:
        self.subtitle_display_mode = (
            SubtitleDisplayMode.BOOK
            if self.subtitle_display_mode == SubtitleDisplayMode.WINDOW
            else SubtitleDisplayMode.WINDOW
        )
        self._refresh_subtitle()
        self._refresh_progress()
